...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Set up Virtuoso provenance database for Heritrace"
    )
    parser.add_argument(
        "-H",
        "--host",
        default=DEFAULT_VIRTUOSO_HOST,
        help=f"Virtuoso host (default: {DEFAULT_VIRTUOSO_HOST})",
    )
    parser.add_argument(
        "-P",
        "--port",
        ...
        help=f"Virtuoso port (default: {DEFAULT_VIRTUOSO_PORT})",
    )
    parser.add_argument(
        "-u",
        "--user",
        default=DEFAULT_VIRTUOSO_USER,
        help=f"Virtuoso user (default: {DEFAULT_VIRTUOSO_USER})",
    )
    parser.add_argument(
        "-k",
        "--password",
