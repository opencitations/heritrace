...
To cite the latest version of this software (3.1.3), use this BibTeX entry:

```bibtex
@software{HERITRACE-3.1.3,
author = {Massari, Arcangelo},
title = {HERITRACE},
url = {https://archive.softwareheritage.org/swh:1:rev:daa180480e6834ab1406f61210663e5720906be4},
version = {3.1.3},
year = {2026}
}
```
