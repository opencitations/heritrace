...
from heritrace.extensions import (get_dataset_endpoint, get_display_rules,
                                  get_form_fields)
...
def time_vault():
    ...
    sortable_properties.extend(get_sortable_properties(selected_class, display_rules, form_fields))
