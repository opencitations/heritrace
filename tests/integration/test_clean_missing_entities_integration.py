...
class TestMissingEntityCleanerIntegration:
    ...
    def test_find_missing_entities_with_references(self, app, setup_test_data) -> None:
        ...
        with app.app_context():
            ...
            INSERT DATA {{
                GRAPH <{setup_test_data["graph_uri"]}> {{
                    <{setup_test_data["person1_uri"]}> <http://example.org/references>
                    <{missing_uri}> .
                }}
            }}
            """
    ...
    def test_remove_references(self, app, setup_test_data) -> None:
        ...
        with app.app_context():
            ...
            INSERT DATA {{
                GRAPH <{setup_test_data["graph_uri"]}> {{
                    <{setup_test_data["person1_uri"]}>
                    <http://example.org/attendedEvent> <{missing_uri}> .
                }}
            }}
            """
            ...
            references = [
                {
                    "subject": setup_test_data["person1_uri"],
                    "predicate": "http://example.org/attendedEvent",
                }
            ]

            # Remove the references
            success = cleaner.remove_references(missing_uri, references)
    ...
    def test_process_missing_entities(self, app, setup_test_data) -> None:
        ...
        with app.app_context():
            ...
            INSERT DATA {{
                GRAPH <{setup_test_data["graph_uri"]}> {{
                    <{setup_test_data["person1_uri"]}> <http://example.org/knows>
                    <{missing_uri1}> .
                    <{setup_test_data["document1_uri"]}> <http://example.org/mentions>
                    <{missing_uri2}> .
                }}
            }}
            """
            ...
            ASK {{
                GRAPH <{setup_test_data["graph_uri"]}> {{
                    ...
                    <http://example.org/mentions> <{missing_uri2}> . }}
                }}
            }}
            """
