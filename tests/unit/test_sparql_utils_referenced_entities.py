...
class TestCollectReferencedEntities:
    ...
    def test_collect_simple_existing_entity_reference(self) -> None:
        """Test collecting a simple existing entity reference."""
        data = {"is_existing_entity": True, "entity_uri": "http://example.org/person1"}
    ...
    def test_collect_nested_entity_references(self) -> None:
    ...
    def test_collect_empty_structure(self) -> None:
    ...
    def test_collect_mixed_with_new_entities(self) -> None:
...
class TestImportReferencedEntities:
    ...
    def test_import_referenced_entities_success(self, mock_collect) -> None:
    ...
    @patch("heritrace.utils.sparql_utils.collect_referenced_entities")
    def test_import_referenced_entities_with_error(self, mock_collect) -> None:
    ...
    @patch("heritrace.utils.sparql_utils.collect_referenced_entities")
    def test_import_referenced_entities_empty_set(self, mock_collect) -> None:
