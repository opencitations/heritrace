...
def test_get_user_default_primary_source_success(mock_current_app, app) -> None:
...
@patch("heritrace.utils.primary_source_utils.current_app")
def test_get_user_default_primary_source_not_set(mock_current_app, app) -> None:
...
def test_get_user_default_primary_source_no_user_id(app) -> None:
...
@patch("heritrace.utils.primary_source_utils.current_app")
def test_get_user_default_primary_source_redis_error(mock_current_app, app) -> None:
...
@patch("heritrace.utils.primary_source_utils.current_app")
def test_save_user_default_primary_source_success(
    mock_current_app, mock_validators_url, app
) -> None:
...
@patch("heritrace.utils.primary_source_utils.is_valid_url", return_value=True)
@patch("heritrace.utils.primary_source_utils.current_app")
def test_save_user_default_primary_source_no_user_id(
    mock_current_app, mock_validators_url, app
) -> None:
...
@patch("heritrace.utils.primary_source_utils.is_valid_url", return_value=True)
@patch("heritrace.utils.primary_source_utils.current_app")
def test_save_user_default_primary_source_no_source(
    mock_current_app, mock_validators_url, app
) -> None:
...
@patch("heritrace.utils.primary_source_utils.is_valid_url", return_value=False)
@patch("heritrace.utils.primary_source_utils.current_app")
def test_save_user_default_primary_source_invalid_url(
    mock_current_app, mock_validators_url, app
) -> None:
...
@patch("heritrace.utils.primary_source_utils.is_valid_url", return_value=True)
@patch("heritrace.utils.primary_source_utils.current_app")
def test_save_user_default_primary_source_redis_error(
    mock_current_app, mock_validators_url, app
) -> None:
