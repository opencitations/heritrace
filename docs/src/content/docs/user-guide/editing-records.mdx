...
The buttons below the title let you edit or delete the entity and open its version history. When editing, the **Save changes** and **Cancel** buttons appear below the record fields.
...
This section lists other entities in the collection that appear similar to the one you are viewing. If you find a duplicate, use the "Merge" button to combine it with the current entity.
