...
- **Custom components** (`default_components/`): URI generator and counter handler implementations. See [Application settings](/heritrace/configuration/app-settings/#custom-components).
