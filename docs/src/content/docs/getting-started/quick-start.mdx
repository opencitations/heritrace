...
**Demo Mode**: Authentication is bypassed for immediate testing. **Production Mode**: Requires ORCID authentication setup - see [Application Settings](/heritrace/configuration/app-settings/) for configuration details.
:::
