...
Set the path to your display rules file via the `DISPLAY_RULES_PATH` environment variable. Example configurations are available in `example_configurations/`.
