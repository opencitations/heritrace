...
ORCID endpoint URLs and scope are hardcoded in `config.py` and do not need to be configured:
- Authorize URL: `https://orcid.org/oauth/authorize`
- Token URL: `https://orcid.org/oauth/token`
- API URL: `https://pub.orcid.org/v2.1`
- Scope: `/authenticate`
