...
|---------------------|-------------|
| `SHACL_PATH` | Path to the [SHACL schema file](/heritrace/configuration/shacl/) that defines data validation rules |
| `DISPLAY_RULES_PATH` | Path to the [display rules file](/heritrace/configuration/display-rules/) that controls how entities are rendered |

Mount your configuration files as Docker volumes to customize them:
