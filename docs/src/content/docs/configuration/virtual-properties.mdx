...
Use virtual properties when your ontology models something as a class, but users naturally think of it as a relationship or when you need to hide implementation details from users who shouldn't need to understand the full ontological structure.
...
The special `${currentEntity}` placeholder is replaced with the URI of the entity currently being created or edited. This is needed to link the intermediate entity back to the main entity.
