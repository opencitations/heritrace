...
counter_handler = MetaCounterHandler(os.path.join(BASE_HERITRACE_DIR, 'counter_handler.db'))

# URI generators for different types of resources
default_uri_generator = DefaultURIGenerator("https://example.com")
meta_uri_generator = MetaURIGenerator("https://w3id.org/oc/meta", "prefix", counter_handler)
